...
<!--    <a href="#" class="sidebar-open-button-mobile"><i class="fa fa-bars"></i></a>-->
    ...
    <li class="dropdown link">
      <a href="#" data-toggle="dropdown" class="dropdown-toggle profilebox"><img src="/ibdnew/PUBLIC/img/logo.png" alt="img"><b>user</b><span class="caret"></span></a>
        <ul class="dropdown-menu dropdown-menu-list dropdown-menu-right">
          ...
          <li><a href="javascript:$.ajax({
				url:'/ibd/index.php/index/logout',
				type:'post',
				success:function re(data)
				{
			...
			});"><i class="fa falist fa-power-off"></i> Logout</a></li>
        </ul>
    </li>
